...
export function PaymentMethods() {
  ...
  return (
    <section id="payment-methods-section" className="py-12 px-4 sm:px-8 lg:px-10 max-w-7xl mx-auto">
              ...
              <Card3D maxTilt={6} perspective={1000} className="h-full">
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-black text-white flex items-center justify-center font-bold text-xs shrink-0 shadow-2xs">
      ...
      {/* Commercial Trust Guarantee Banner - 3D Bento Card */}
