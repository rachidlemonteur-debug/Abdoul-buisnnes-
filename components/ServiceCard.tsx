...
export function ServiceCard({ service, index }: ServiceCardProps) {
  return (
    <ScrollReveal delay={index * 90} direction="up" className="h-full">
      <article
        id={`service-card-${service.id}`}
        className="group relative flex h-full flex-col overflow-hidden rounded-[2.5rem] border border-gray-200/90 bg-white p-7 sm:p-8 shadow-xs transition-all duration-300 hover:shadow-md hover:border-gray-300"
      >
        {/* Top Header Pill */}
        ...
        <div className="relative h-48 w-full overflow-hidden rounded-2xl bg-gray-100 mb-5">
          <Image
            src={service.image}
